        ...
        if (word.isVertical()== true)
        {
            ...
            for (int i = 0;i< word.getTiles().length;i++)
            {
                ...
                if (BonousScore.containsKey(str3));
                {
                    ...
                    if(Bonous==null)
                    {
                        sum += TheBoard.matBoard[word.getRow()+i][word.getCol()].score;
                        continue;
                    }
                    switch (Bonous) {
                        case "star": {
                        ...
                        case "DoubleLettScor": {
                            sum  += 2 * TheBoard.matBoard[word.getRow()+i][word.getCol()].score;
                        }break;
                        case "TripelLettScor": {
                            sum += 3 *  TheBoard.matBoard[word.getRow()+i][word.getCol()].score;
                        }break;
                        case "DoubleWorScore": {
                            flag *= 2;
                            sum +=  TheBoard.matBoard[word.getRow()+i][word.getCol()].score;
        ...
        else // not vertical
        {
            ...
            for (int j = 0;j< word.getTiles().length;j++)
            {
                ...
                if (BonousScore.containsKey(str3));
                {
                    ...
                    if(Bonous==null) {
                        sum +=  TheBoard.matBoard[word.getRow()][word.getCol()+j].score;
                        continue;
                    }
                    switch (Bonous) {
                        case "star": {
                        ...
                        case "DoubleLettScor": {
                            sum  += 2 * TheBoard.matBoard[word.getRow()][word.getCol()+j].score;
                        }break;
                        case "TripelLettScor": {
                            sum += 3 * TheBoard.matBoard[word.getRow()][word.getCol()+j].score;
                        }break;
                        case "DoubleWorScore": {
                            flag *= 2;
                            sum += TheBoard.matBoard[word.getRow()][word.getCol()+j].score;
